export function StatCard({ label, value }) {
  return (
    <div className="group relative rounded-xl border border-slate-200 bg-white px-6 py-5 text-left shadow-[0_1px_2px_rgba(15,23,42,0.06)] transition-all duration-300 hover:-translate-y-0.5 hover:shadow-[0_8px_24px_rgba(15,23,42,0.12)]">
      ...
      <div className="pl-3">
        <div className="font-serif text-3xl font-bold leading-none tracking-tight text-slate-900 lg:text-4xl">
          {value}
        </div>
        <div className="mt-2 font-mono text-[10px] font-semibold uppercase tracking-[0.25em] text-slate-500">
          {label}
        </div>
      </div>
    </div>
